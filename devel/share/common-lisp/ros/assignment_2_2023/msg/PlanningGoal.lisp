...
(cl:defmethod cl:initialize-instance :after ((m <PlanningGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlanningGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name assignment_2_2023-msg:<PlanningGoal> is deprecated: use assignment_2_2023-msg:PlanningGoal instead.")))

(cl:ensure-generic-function 'target_pose-val :lambda-list '(m))
(cl:defmethod target_pose-val ((m <PlanningGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader assignment_2_2023-msg:target_pose-val is deprecated.  Use assignment_2_2023-msg:target_pose instead.")
  (target_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PlanningGoal>)))
  ...
  "assignment_2_2023/PlanningGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PlanningGoal)))
  "Returns string type for a message object of type 'PlanningGoal"
  "assignment_2_2023/PlanningGoal")
