...
"""autogenerated by genpy from assignment_2_2023/PlanningActionResult.msg. Do not edit."""
import codecs
import sys
...
class PlanningActionResult(genpy.Message):
  ...
  _type = "assignment_2_2023/PlanningActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','assignment_2_2023/PlanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = assignment_2_2023.msg.PlanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = assignment_2_2023.msg.PlanningResult()
